...
describe('strain', () => {
  ...
  it('keeps on empty array returns empty array', () => {
    expect(strain.keep([], (e) =>  e < 10 ))
      .toEqual([]);
  });

  it('keeps everything ', () => {
    expect(strain.keep([1, 2, 3], (e) =>  e < 10 ))
      .toEqual([1, 2, 3]);
  });

  it('keeps first and last', () => {
    expect(strain.keep([1, 2, 3], (e) => e % 2 === 1 ))
      .toEqual([1, 3]);
  });

  it('keeps neither first nor last', () => {
    expect(strain.keep([1, 2, 3, 4, 5], (e) => e % 2 === 0 ))
      .toEqual([2, 4]);
  });
  ...
  it('keeps strings', () => {
    ...
    expect(result)
      .toEqual('zebra zombies zelot'.split(' '));
  });
  ...
  it('keeps arrays', () => {
    ...
    expect(result)
      .toEqual([[5, 5, 5], [5, 1, 2], [1, 5, 2], [1, 2, 5]]);
  });

  it('empty discard', () => {
    expect(strain.discard([], (e) =>  e < 10 ))
      .toEqual([]);
  });

  it('discards nothing', () => {
    expect(strain.discard([1, 2, 3], (e) =>  e > 10 ))
      .toEqual([1, 2, 3]);
  });

  it('discards first and last', () => {
    expect(strain.discard([1, 2, 3], (e) =>  e % 2 === 1 ))
      .toEqual([2]);
  });
  ...
  it('discards strings', () => {
    ...
    expect(result)
      .toEqual('apple banana cherimoya'.split(' '));
  });
