...
describe('encode', () => {
  ...
  it('encodes no', () =>
    expect(atbash.encode('no'))
      .toEqual('ml'));

  it('encodes yes', () =>
    expect(atbash.encode('yes'))
      .toEqual('bvh'));

  it('encodes OMG', () =>
    expect(atbash.encode('OMG'))
      .toEqual('lnt'));

  it('encodes O M G', () =>
    expect(atbash.encode('O M G'))
      .toEqual('lnt'));

  it('encodes long words', () =>
    expect(atbash.encode('mindblowingly'))
  ...
  it('encodes sentences', () =>
    expect(atbash.encode('Truth is fiction.'))
